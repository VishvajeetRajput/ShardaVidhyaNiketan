...
<style>
    ...
    text-shadow: 2px 2px #ff4500; /* Bright orange-red shadow */
		...
		<div class="section_containerop"
			...
			<div class="section_wrapper_right"
				...
				<center>
					...
					<h3 th:utext="${studentName}" class="student-name"></h3>
					...
					<div class="containerio" id="11thMath">
						...
						<img style="height: 10%; width: 50%; display: none;" id="image"
							src="Images/marksheet9th.jpg"> <a id="downloadLink"
...
let hindi=studentData.hindi;
let english=studentData.english;
let science=studentData.science;
let soScience=studentData.soScience;
let sanskrit=studentData.sanskrit;
let mathematics=studentData.mathematics;
let result=studentData.result;
let percentage=studentData.percentage;
let grade=studentData.grade;
...
document.getElementById("downloadLink").addEventListener("click", function() {
    ...
    function drawCanvas() {
        ...
        context.font = "43px Arial"; // Adjust font size and style as needed
       ...
       context.fillText(hindi, 1370, 2280);
        ...
        context.fillText(science, 1370, 2440);
        context.fillText(soScience, 1370, 2520);
        context.fillText(sanskrit, 1370, 2600);
        context.fillText(mathematics, 1370, 2680); 
        
        context.fillText(grade, 880, 2840);
        context.fillText(result, 2190, 2830);
        context.fillText(percentage, 500, 3010); 
        
            
        // Dynamically set the download file name
        var downloadFileName = `Marksheet_${studentRollNo}_${name}_${studentClass}.jpg`;

        // Update the download link with dynamic file name and image data
