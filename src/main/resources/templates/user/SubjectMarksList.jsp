		...
		<table>
			<thead>
				<tr>
					...
					<th>SocialScience</th>
					<th>History</th>
					<th>PoliticalScience</th>
					<th>Economics</th>
					<th>BusinessStudies</th>
					<th>BookkeepingAndAccountancy</th>
					<th>BusinessEconomics</th>
					<th>Physics</th>
					<th>Chemistry</th>
					<th>Biology</th>
			...
			<tbody>
				<tr th:each="students : ${data}">
					<td th:text="${students.studentName}"></td>
					<td th:text="${students.studentRollNo}"></td>
					<td th:text="${students.mathematic}"></td>
					<td th:text="${students.english}"></td>
					<td th:text="${students.hindi}"></td>
					<td th:text="${students.environment}"></td>
					<td th:text="${students.sanskrit}"></td>
					<td th:text="${students.science}"></td>
					<td th:text="${students.socialScience}"></td>
					<td th:text="${students.history}"></td>
					<td th:text="${students.economics}"></td>
					<td th:text="${students.businessStudies}"></td>
					<td th:text="${students.bookkeepingAndAccountancy}"></td>
					<td th:text="${students.businessEconomics}"></td>
					<td th:text="${students.physics}"></td>
					<td th:text="${students.chemistry}"></td>
					<td th:text="${students.biology}"></td>
				</tr>
			</tbody>
		</table>
	</div>

	<div id="errorMessage" class="container"
		style="display: none; margin-top: 10%; text-align: center;">
