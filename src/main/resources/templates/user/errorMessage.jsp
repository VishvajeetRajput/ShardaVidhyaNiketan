		...
		<div class="section_container_wrapper">
			<div class="section_wrapper_left">
				...
				<div id="200" style="margin-top: 20px; display: none;" >
					...
					<h5
						style="color: rgb(56, 23, 118); letter-spacing: 1.5px; text-align: center;">
						Student Name: <span style="color:#333333;" th:utext="${studentName}"></span>
					</h5>
					<h5
						style="color: rgb(56, 23, 118); letter-spacing: 1.5px; text-align: center;">
						Roll Number: <span th:utext="${rollNumber}"></span>
					</h5>
					<div>
						<div></div>
						<img th:src="@{/Images/successpayment.gif}"
							style="margin-top: 10px; height: 120px; width: 150px; display: block; margin-left: auto; margin-right: auto; width: 50%;" />
					</div>
					<h5
						style="color: green; letter-spacing: 1.5px; text-align: center;">
						<span th:utext="${discription}"></span>
					</h5>
				...
				<div id="201" style="margin-top: 20px;display: none;" >
					...
					<div>
						<div></div>
						<img th:src="@{/Images/errorFailed.gif}"
							style="margin-top: 10px; height: 120px; width: 150px; display: block; margin-left: auto; margin-right: auto; width: 50%;" />
					</div>
					
				</div>
				<!--nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn  -->
				<div id="202" style="margin-top: 20px;display: none;">
...
console.log("akdhaskjdhs "+code);
 ...
 case "200":
   ...
   break;
 case "201":
	 console.log("akdhas 201 "+code);
	 document.getElementById("201").style.display="block";

   break;
 default:
	 console.log("akdh def "+code);
