		...
		<form id="myForm" action="/studentRegistrationRequest" method="post">
			...
			<div class="form-group">
				<label for="studentFatherName">Father's Name:</label> <input
					type="text" id="studentFatherName"  name="studentFatherName"
					required>
			</div>
			<div class="form-group">
				<label for="studentMotherName">Mother's Name:</label> <input
					type="text" id="studentMotherName"  name="studentMotherName"
					required>
			</div>
			<div class="form-group">
				...
				<div class="form-group container1">
					...
					<div class="form-group input-wrapper" style="margin-left: 5%; margin-top: 3px">
						...
						<div class="radio-buttons" style="margin-left: 1%; margin-top: 5px">
							...
							</label><input type="radio" name="studentGender" value="Female" required>
						</div>
					</div>
