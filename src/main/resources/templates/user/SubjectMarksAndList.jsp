			...
			<div class="section_wrapper_right"
				...
				<div class="form-group">
					<h3 style="color: rgb(56, 23, 118); letter-spacing: 1px">
						Add Student Subject Marks</h3>
					<br> 
					<a th:href="@{/addSubjectMarkrs}" style="text-decoration: none;"> <button id="StudentScholarNoBtn"
				...
				<div class="form-group">
					...
					<div></div>
					<a th:href="@{/viewStudentSubjectMarks}" style="text-decoration: none;"><button id="StudentScholarNoBtn"
						style="width: 100%; margin-top: 8px; padding: 5px; border-radius: 20px;"
						type="button" class="btn btn-outline-primary">
						Click here to view student marks list
					</button></a>
				</div>
