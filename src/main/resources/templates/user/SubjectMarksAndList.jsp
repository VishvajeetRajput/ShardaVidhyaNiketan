		...
		<div class="section_container"
			...
			<div class="section_wrapper_right"
				...
				<div class="form-group">
					<h3 style="color: rgb(56, 23, 118); letter-spacing: 1px">Add
						Student Subject Marks</h3>

					<select id="studentClassSelect" name="studentClass"
						class="form-group custom-select">
						<option value="KG1st">KG1st</option>
						<option value="KG2nd">KG2nd</option>
					...
					<br> <a id="addMarksLink" href="#"style="text-decoration: none;">
						<button id="StudentScholarNoBtn"
							...
							type="button" class="btn btn-outline-primary">Click here
				...
				<div class="form-group">
					<h3 style="color: rgb(56, 23, 118); letter-spacing: 1px">
						Student Subject List</h3>
					<br>

					<div></div>
					<a th:href="@{/viewStudentSubjectMarks}"
						style="text-decoration: none;"><button
							id="StudentScholarNoBtn"
							style="width: 100%; margin-top: 8px; padding: 5px; border-radius: 20px;"
							type="button" class="btn btn-outline-primary">Click here
							to view student marks list</button></a>
				</div>
...
document.getElementById('studentClassSelect').addEventListener('change', function() {
    ...
    link.href = '/addSubjectMarks/' + encodeURIComponent(selectedValue);
});
