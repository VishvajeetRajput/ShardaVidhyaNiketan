...
<html xmlns:th="http://www.thymeleaf.org">
   ...
   <body>
      <div class="form-container">
         <form th:action="@{/update9thMarks}" th:object="${student}" method="post">
            <input type="hidden" th:field="*{id}" />
            <label>Student Roll No: : <input type="text" th:field="*{studentRollNo}" required="required" pattern="[0-9]+(\.[0-9]+)?" title="Please enter a numerical value" /></label><br/>
            ...
            <label>Science: <input type="text" th:field="*{science}" required="required" pattern="[0-9]+(\.[0-9]+)?" title="Please enter a numerical value" /></label><br/>
            <label>So. Science: <input type="text" th:field="*{soScience}" required="required" pattern="[0-9]+(\.[0-9]+)?" title="Please enter a numerical value" /></label><br/>
            <label>Sanskrit: <input type="text" th:field="*{sanskrit}" required="required" pattern="[0-9]+(\.[0-9]+)?" title="Please enter a numerical value" /></label><br/>
