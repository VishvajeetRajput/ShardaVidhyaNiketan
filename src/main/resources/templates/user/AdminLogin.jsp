			...
			<div class="section_wrapper_right"
				...
				<div>
					<label
						...
						</label></br> <a th:href="@{/studentRegistration}" style="text-decoration: none;"> <button class="button-63" role="button">Click here to Register Students</button></a>
				</div>
				
				<div>
					<label
						style="color: rgb(56, 23, 118); display: block; letter-spacing: 3px; font-weight: 600; font-size: 16px; line-height: 10px;">Students List
						</label></br> <a th:href="@{/viewStudentDetails}" style="text-decoration: none;"><button class="button-63" role="button">Click here to view Students list</button></a>
				</div>
				<div>
					<label
						style="color: rgb(56, 23, 118); display: block; letter-spacing: 3px; font-weight: 600; font-size: 16px; line-height: 10px; ">Students MarkSheet
						</label></br> <a th:href="@{/searchStudent}" style="text-decoration: none;"> <button class="button-63" role="button">Download Students MarkSheet</button></a>
				</div><!--searchStudent  -->
				<div>
					<label
						style="color: rgb(56, 23, 118); display: block; letter-spacing: 3px; font-weight: 600; font-size: 16px; line-height: 10px; ">Add Student Subjects Mark
						</label></br> <a th:href="@{/SubjectMarksAndList}" style="text-decoration: none;"> <button class="button-63" role="button">Add Students Subjects Mark</button></a>
				</div>
				<div></div>
							<div></div>
			</div>
